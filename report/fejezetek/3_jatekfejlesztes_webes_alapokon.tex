\begin{MyChapter}{Játékfejlesztés webes alapokon}	
	...
	\begin{MySection}{Általános célú javascript keretrendszerek}
		...
		Konkrét JavaScript keretrendszerek pedig például a Vue, a React vagy az Angular. Ezek egyébként ebben a sorrendben a 2017-es év első három leghasználtabb JS keretrendszerei voltak a weboldal alapján, melyről fentebb szó volt. 
		% TODO irodalom --->
