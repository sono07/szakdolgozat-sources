\begin{MyChapter}{Játékfejlesztés általánosan}
	...
	\begin{MySection}{Játékfejlesztés keretrendszerekkel}
		...
		%\begin{MySubSection}{OpenGL}
		%	
		%\end{MySubSection}
		
		% TODO 	- opengl
		% TODO Actually you cannot compare OpenGL and game engines. OpenGL is just a graphics programming API.. ennek ellenére is ideírjam?
