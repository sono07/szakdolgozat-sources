\begin{MyChapter}{Játékfejlesztés általánosan}
	...
	\begin{MySection}{Játékfejlesztés történelme}
		...
		% TODO ez a link esetleg érdekességként?
	...
	\begin{MySection}{Játékfejlesztés alapjai} 
		...
		% TODO android /iphone megjelenése | érintőképernyős mobil megjelenése-> új lehetőségek | jó gpu jobb akksik, erősebb hardver - mobil /tablet / hordozható eszközök
		...
		% TODO ha van keresni mobil appok fejlődéséről diagram!! - piac ugrásszerű fejlődése
		...
		% TODO egyéb lehetőségek mobillal: képernyő megosztása tv-re
	...
	\begin{MySection}{Játékfejlesztés keretrendszerek nélkül}
		...
		\end{itemize}
		% TODO  - hátrány
		Kezdő, tapasztalatlanabb játékfejlesztők számára azonban ez a folyamat sokkal lassabb, időigényesebb lehet, mint egy már kész motor használatával elkészített alkalmazás.
		% TODO 	- c++, low-level
		% TODO 	- példa ilyenre
	\end{MySection}
	...
	\begin{MySection}{Játékfejlesztés keretrendszerekkel}
		...
		Nem csak az egész játékmotort egyben, hanem önmagában csak egy-egy alrendszert is lehetőségünk van megvásárolni, mely abban az esetben lehet például kifizetődő, ha egy már kipróbált, megfelelő alrendszert beszerezni olcsóbb, mint egy saját, új alrendszer kifejlesztése.
		% TODO irodalom -> 
		% https://users.iit.uni-miskolc.hu/~mileff/grafika/Grafika_programozasa_jegyzet_v0.66_Mileff_P.pdf
