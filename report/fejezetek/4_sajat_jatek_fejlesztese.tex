\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Célok meghatározása}
		...
		Elsődlegesen azt szeretném elérni, hogy az alap funkcionalitás meglegyen, majd ha ez kész, csak ezután szeretném a fentebbi tulajdonságokkal kibővíteni a játékot. Ami még a célom, hogy a továbbiakban is lehetőség legyen bővítésre, illetve hogy az esetleges továbbfejlesztési lehetőségeket viszonylag könnyen intergálni tudjuk a programba a későbbiekben.
	\end{MySection}
	...
	\begin{MySection}{Felhasznált eszközök, technológiák}
		...
		\begin{itemize} % TODO WIP
			...
			% TODO ez neked bele volt írva, nekem is kellhet az oprendszer amin írom?		\item Windows 10
