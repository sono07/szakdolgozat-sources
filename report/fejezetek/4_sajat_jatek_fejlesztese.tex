\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Felhasznált eszközök, technológiák}
		...
		\begin{itemize} % TODO WIP
			...
			\item JavaScript - alapvetően a programozási nyelvként a js-t választottam hiszen a választott játékmotor is ezt támogatja. % TODO erről még írni vmit, hogy miért ezt választom ezenkívül?
			\item TypeScript - Mivel a Js alapvetően nem tartalmaz típusokat, pedig az megkönnyíti a fejlesztő dolgát, így a ts-t is használom, ahol lehetőség van rá. De mint mondtam a játékmotor nem teljesen kompatibilis ezzel, így nem lehet csak ts-sel megoldani.
			% TODO JS TS-t tartalmilag átírni !!
			...
			% TODO WIP ->
			% NPM csomagkezelő(?)
			% Webpack bundler (ami lefordítja a Typescript kódot Javascriptre, majd egy fájllá alakítja, hogy azt lehessen használni a HTML oldalon.)
