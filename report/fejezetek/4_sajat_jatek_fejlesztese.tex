\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Végeredmény}
		...
		% TODO mindegyik tornyot egyesével le írjam, hogy mit csinál??
		% esetleg kézzel készíteni egy táblázatot, a torony képével, képességeivel, árával - ha lesz idő
		
		A fenti felhasználói felületen (lásd \myref{fig:jatekHasznalat:felso_ui} ábra) balról jobbra haladva, a következőket láthatjuk:
