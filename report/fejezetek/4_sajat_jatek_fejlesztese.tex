\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Felhasznált eszközök, technológiák}
		...
		\begin{itemize} % TODO WIP
			...
			\item Webpack bundler % (ami lefordítja a Typescript kódot Javascriptre, majd egy fájllá alakítja, hogy azt lehessen használni a HTML oldalon.)
			% NPM package-k pl Jest
			\item PlantUML - A PlantUML használatával sokkal hatékonyabban tudunk a program egyes részeiről UML diagramokat készíteni, így rengeteg időt lehet spórolni vele. Online elérhető az alábbi linken: https://plantuml.com/ % TODO ellenőrizni a leírást h valóban ezt csinálja-e vagy mást kellene ide írnom
			\item  https://www.photopea.com/ % (photoshop klón), a képek, assetek módosításához, vágásához
			...
			% TODO ellenőrizni a leírást h valóban ezt csinálja-e
			\item Sprite sheet cutter - Az internetről felhasznált ingyenes sprite sheeteken található spriteok nem mindegyikére volt szükségem a játékhoz, így ennek a programnak % TODO program/ szoftver? mi ez?
			a segítségével szét tudtam darabolni őket önálló képekre, ezáltal lehetőségem volt rá, hogy csak a szükségeseket használjam fel a későbbiekben. Ezen a linken érhető el online: https://ezgif.com/sprite-cutter/ % TODO ellenőrizni a leírást h valóban ezt csinálja-e
		\end{itemize}
	\end{MySection}
