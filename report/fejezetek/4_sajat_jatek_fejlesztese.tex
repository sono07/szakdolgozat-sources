\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Végeredmény}
		...
		%\begin{table}[h]
		%	\centering
		%	\caption{Első típusú torony tulajdonságai}
		%	\label{tab:torony_tipus_0}
		%	\begin{tabular}{|l|c|c|c|}
		%		\hline
		%		Torony szintje, erőssége & 1 & 2 & 3 \\ \hline
		%		Kinézet & \includegraphics[scale=1.4]{kepek/jatekHasznalat/torony_01} & \includegraphics[scale=1.4]{kepek/jatekHasznalat/torony_02} & \includegraphics[scale=1.4]{kepek/jatekHasznalat/torony_03} \\ \hline
		%		Ár &  &  &  \\ \hline
		%		Maximum lövéstávolság &  &  &  \\ \hline
		%		Tűzgyorsaság (lövés/sec) &  &  &  \\ \hline
		%		Sebzés &  &  &  \\ \hline
		%		Százalékos sebzés &  &  &  \\ \hline
