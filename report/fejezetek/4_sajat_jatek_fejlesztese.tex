\begin{MyChapter}{Saját játék fejlesztése}
	...
	\begin{MySection}{Tervezés}
		...
		%TODO \texttt{}-n belüli részeket nem engdei wrappelni, így kilógnak az oldalról
...
this.gameStateStore.actionChangedCallbacks.§\color{jsMethod}push§((action) => {
	...
	\begin{MySection}{Tesztelés}
		...
		% TODO példa teszt + kód + leírás
			...
			% \begin{figure}[H]
			% 	\centering
			% 	\includegraphics[scale=0.5]{kepek/teszt/tesztPelda1}
			% 	\caption{Rosszul működő pályagenerálás}
			% 	\label{fig:teszt:tesztPelda1}
			% \end{figure}
		...
		% teszt futásidő
			% TODO Abból is látható, hogy mennyire nem kifejezetten tesztelhetően készítették el a Phaser-t, hogy az a pár viszonylag egyszerű teszt is x /* TODO idő */ másodperc alatt futtott le.
