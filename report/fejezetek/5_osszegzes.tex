\begin{MyChapter}{Összegzés}
	...
	% TODO Továbbfejlesztési lehetőség:
	% Mobilon is működik, de az "egér" kezeléssel vannak problémák, ez javítható lehet -> további elérendő cél lehetne mobilalkalmazásként kiadni - hiszen a js alapvetően bármilyen platformon futtatható
\end{MyChapter}